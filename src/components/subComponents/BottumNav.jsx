...
import { MdOutlineVideoLibrary } from 'react-icons/md'; // Visuals icon
...
const BottomNav = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-black shadow-lg py-2 flex justify-around items-center border-t border-gray-200 opacity-80">
            ...
            {/* About Us (replacing Community) */}
            <button onClick={() => navigate('/aboutUs')} className="flex flex-col items-center text-gray-500 hover:text-gray-900">
                <AiOutlineInfoCircle size={24} />
                <span className="text-xs">About Us</span>
            </button>

            {/* Visuals (replacing Classes) */}
            <button onClick={() => navigate('/trailvideo')} className="flex flex-col items-center text-gray-500 hover:text-gray-900">
